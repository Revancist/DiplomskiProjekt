...
#include "DiplomskiProjectCharacter.generated.h"
...
UCLASS(config=Game)
class ADiplomskiProjectCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class ADiplomskiProjectProjectile> ProjectileClass;
